...
return fdivide(((_Z48discountingBondEngineCalculateSettlementValueGpu12inArgsStructi15cashFlowsStructi(inArgs, bondNum, cashFlows, numLegs)) * (100.0)) , __cuda_local_var_42649_10_non_const_currentNotional);
...
return fdivide(__cuda_local_var_42707_11_non_const_totalNPV , (_Z34bondsYieldTermStructureDiscountGpu20bondsYieldTermStruct15bondsDateStruct(discountCurve, npvDate)));
...
case 0:
# 524 "bondsKernelsGpu.cu"
__cuda_local_var_42762_11_non_const_r = ( fdivide((compound - (1.0)) , t));
...
__cuda_local_var_42816_11_non_const_dirtyPrice = ( fdivide(__cuda_local_var_42816_11_non_const_dirtyPrice , ( fdivide((100.0) , (_Z15bondNotionalGpuv())))));
...
return _Z14solverSolveGpu12solverStruct15irrFinderStructddd15cashFlowsStructi(__cuda_local_var_42822_15_non_const_solver, __cuda_local_var_42824_17_non_const_objFunction, accuracy, guess, ( fdivide(guess , (10.0))), leg, numLegs);
...
__cuda_local_var_42957_25_non_const_dx = ( fdivide((__cuda_local_var_42958_10_non_const_xh - __cuda_local_var_42958_14_non_const_xl) , (2.0)));
...
__cuda_local_var_42957_25_non_const_dx = ( fdivide(__cuda_local_var_42957_10_non_const_froot , __cuda_local_var_42957_17_non_const_dfroot));
...
__cuda_local_var_42958_14_non_const_xl = (solver.root_); } else {
...
__cuda_local_var_43003_10_non_const_dPdy -= ( fdivide(((__cuda_local_var_43013_10_non_const_c * __cuda_local_var_43012_10_non_const_t) * __cuda_local_var_43014_10_non_const_B) , ((1.0) + ( fdivide(__cuda_local_var_43004_10_non_const_r , __cuda_local_var_43005_10_non_const_N))))); }
...
__cuda_local_var_43003_10_non_const_dPdy -= (((__cuda_local_var_43013_10_non_const_c * __cuda_local_var_43014_10_non_const_B) * __cuda_local_var_43014_10_non_const_B) * __cuda_local_var_43012_10_non_const_t); } else {
...
return fdivide(((-1.0) * __cuda_local_var_43003_10_non_const_dPdy) , __cuda_local_var_43002_10_non_const_P);
