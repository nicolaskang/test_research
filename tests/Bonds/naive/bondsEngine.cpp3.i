...
return (dataType)(fdivide(((_Z48discountingBondEngineCalculateSettlementValueGpu12inArgsStructi15cashFlowsStructi(inArgs, bondNum, cashFlows, numLegs)) * (100.0)), __cuda_local_var_42895_11_non_const_currentNotional));
...
return (dataType)(fdivide(__cuda_local_var_43002_18_non_const_totalNPV, (_Z34bondsYieldTermStructureDiscountGpu20bondsYieldTermStruct15bondsDateStruct(discountCurve, npvDate))));
...
__cuda_local_var_43088_18_non_const_r = ((dataType)(fdivide((compound - (1.0)), t)));
...
__cuda_local_var_43191_18_non_const_dirtyPrice = ((dataType)(fdivide(__cuda_local_var_43191_18_non_const_dirtyPrice, (fdivide((100.0), (_Z15bondNotionalGpuv()))))));
...
return _Z14solverSolveGpu12solverStruct15irrFinderStructddd15cashFlowsStructi(__cuda_local_var_43215_15_non_const_solver, __cuda_local_var_43217_18_non_const_objFunction, accuracy, guess, ((dataType)(fdivide(guess, (10.0)))), leg, numLegs);
...
__cuda_local_var_43419_26_non_const_dx = ((dataType)(fdivide((__cuda_local_var_43420_11_non_const_xh - __cuda_local_var_43420_15_non_const_xl), (2.0))));
...
__cuda_local_var_43419_26_non_const_dx = ((dataType)(fdivide(__cuda_local_var_43419_11_non_const_froot, __cuda_local_var_43419_18_non_const_dfroot)));
...
__cuda_local_var_43420_15_non_const_xl = (solver.root_);
# 1060 "bondsKernelsGpu.cu"
}
# 1060 "bondsKernelsGpu.cu"
else
...
__cuda_local_var_43491_11_non_const_dPdy -= ((double)(fdivide(((__cuda_local_var_43505_13_non_const_c * __cuda_local_var_43503_13_non_const_t) * __cuda_local_var_43506_13_non_const_B), ((1.0) + ((double)(fdivide(__cuda_local_var_43492_11_non_const_r, __cuda_local_var_43493_11_non_const_N)))))));
# 1102 "bondsKernelsGpu.cu"
}
...
return (dataType)(fdivide(((-1.0) * __cuda_local_var_43491_11_non_const_dPdy), __cuda_local_var_43490_11_non_const_P));
