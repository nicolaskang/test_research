...
# 5 "sgemm_kernel.cu"
__attribute__((global)) __attribute__((__used__)) extern void _Z9mysgemmNTPKfiS0_iPfiiff(const float *, int, const float *, int, float *, int, int, float, float);
...
# 7 "sgemm_kernel.cu" 2
# 5 "sgemm_kernel.cu"
__attribute__((global)) __attribute__((__used__)) void _Z9mysgemmNTPKfiS0_iPfiiff(
# 5 "sgemm_kernel.cu"
const float *A,
# 5 "sgemm_kernel.cu"
int lda,
...
# 13 "sgemm_kernel.cu"
static __attribute__((shared)) __attribute__((__used__)) float __cuda_local_var_61126_32_non_const_b_s[8][16];
# 25 "sgemm_kernel.cu"
