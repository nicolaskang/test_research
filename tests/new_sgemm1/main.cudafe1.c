...
{  unsigned __T20;
 unsigned __T21;
# 43 "sgemm_kernel.cu"
 struct dim3 __cuda_local_var_61156_7_non_const_grid;
# 43 "sgemm_kernel.cu"
 struct dim3 __cuda_local_var_61156_31_non_const_threads;
# 32 "sgemm_kernel.cu"
...
{ (__cuda_local_var_61156_7_non_const_grid.x) = __T20; (__cuda_local_var_61156_7_non_const_grid.y) = __T21; (__cuda_local_var_61156_7_non_const_grid.z) = 1U; }
# 43 "sgemm_kernel.cu"
} {
# 421 "/usr/local/cuda/bin/../targets/x86_64-linux/include/vector_types.h"
(__cuda_local_var_61156_31_non_const_threads.x) = 16U; (__cuda_local_var_61156_31_non_const_threads.y) = 8U; (__cuda_local_var_61156_31_non_const_threads.z) = 1U;
# 43 "sgemm_kernel.cu"
}
(cudaConfigureCall(__cuda_local_var_61156_7_non_const_grid, __cuda_local_var_61156_31_non_const_threads, 0UL, ((struct CUstream_st *)0LL))) ? ((void)0) : (__device_stub__Z9mysgemmNTPKfiS0_iPfiiff(A, lda, B, ldb, C, ldc, k, alpha, beta));
{  enum cudaError __cuda_local_var_61158_16_non_const_err;
# 45 "sgemm_kernel.cu"
__cuda_local_var_61158_16_non_const_err = (cudaGetLastError()); if (0 != ((int)__cuda_local_var_61158_16_non_const_err)) { fprintf(stderr, ((const char *)"Cuda error: %s in file \'%s\' in line %i : %s.\n"), ((const char *)("mySgemm")), ((const char *)("sgemm_kernel.cu")), 45, (cudaGetErrorString(__cuda_local_var_61158_16_non_const_err))); exit(1); } } ; 
}
# 13 "main.cu"
int main( int argc,  char **argv) {  _ZNSt6vectorIfSaIfEE10value_typeE __T22;
 _ZNSt6vectorIfSaIfEE14allocator_typeE __T23;
# 14 "main.cu"
 float *__cuda_local_var_61165_9_non_const_dA;
# 14 "main.cu"
 float *__cuda_local_var_61165_14_non_const_dB;
# 14 "main.cu"
 float *__cuda_local_var_61165_19_non_const_dC;
 size_t __cuda_local_var_61166_9_non_const_A_sz;
# 15 "main.cu"
 size_t __cuda_local_var_61166_15_non_const_B_sz;
# 15 "main.cu"
 size_t __cuda_local_var_61166_21_non_const_C_sz;
 int __cuda_local_var_61167_6_non_const_matArow;
# 16 "main.cu"
 int __cuda_local_var_61167_15_non_const_matAcol;
 int __cuda_local_var_61168_6_non_const_matBrow;
# 17 "main.cu"
 int __cuda_local_var_61168_15_non_const_matBcol;
 struct _ZSt6vectorIfSaIfEE __cuda_local_var_61169_21_non_const_matA;
# 18 "main.cu"
 struct _ZSt6vectorIfSaIfEE __cuda_local_var_61169_27_non_const_matBT;
 int __cuda_local_var_61170_6_non_const_n;
# 38 "main.cu"
 struct _ZSt6vectorIfSaIfEE __cuda_local_var_61189_21_non_const_matC;
# 18 "main.cu"
_ZNSt6vectorIfSaIfEEC1Ev((&__cuda_local_var_61169_21_non_const_matA)); _ZNSt6vectorIfSaIfEEC1Ev((&__cuda_local_var_61169_27_non_const_matBT));

if (argc == 2) {
__cuda_local_var_61170_6_non_const_n = (atoi(((const char *)(argv[1]))));
__cuda_local_var_61166_9_non_const_A_sz = (((unsigned long)(__cuda_local_var_61170_6_non_const_n * __cuda_local_var_61170_6_non_const_n)) * 4UL);
__cuda_local_var_61166_15_non_const_B_sz = __cuda_local_var_61166_9_non_const_A_sz;
__cuda_local_var_61166_21_non_const_C_sz = __cuda_local_var_61166_9_non_const_A_sz;
__cuda_local_var_61167_6_non_const_matArow = __cuda_local_var_61170_6_non_const_n;
__cuda_local_var_61167_15_non_const_matAcol = __cuda_local_var_61170_6_non_const_n;
__cuda_local_var_61168_6_non_const_matBrow = __cuda_local_var_61170_6_non_const_n;
__cuda_local_var_61168_15_non_const_matBcol = __cuda_local_var_61170_6_non_const_n;
} else  {
printf(((const char *)"error in input")); {
_ZNSt6vectorIfSaIfEED1Ev((&__cuda_local_var_61169_27_non_const_matBT)); _ZNSt6vectorIfSaIfEED1Ev((&__cuda_local_var_61169_21_non_const_matA)); return 0; }
} {
 int i;
# 33 "main.cu"
i = 0; for (; (i < __cuda_local_var_61170_6_non_const_n); i++) { {
 int j;
# 34 "main.cu"
j = 0; for (; (j < __cuda_local_var_61170_6_non_const_n); j++) {  _ZNSt6vectorIfSaIfEE10value_typeE __T24;
 _ZNSt6vectorIfSaIfEE10value_typeE __T25;
# 35 "main.cu"
_ZNSt6vectorIfSaIfEE9push_backERKf((&__cuda_local_var_61169_21_non_const_matA), ((((*(_ZNSt6vectorIfSaIfEE10value_typeE *)&__T24)) = (((float)(rand())) / (53687092.0F))) , (&__T24)));
_ZNSt6vectorIfSaIfEE9push_backERKf((&__cuda_local_var_61169_27_non_const_matBT), ((((*(_ZNSt6vectorIfSaIfEE10value_typeE *)&__T25)) = (((float)(rand())) / (53687092.0F))) , (&__T25)));
} } } }
_ZNSt6vectorIfSaIfEEC1EmRKfRKS0_((&__cuda_local_var_61189_21_non_const_matC), ((_ZNSt6vectorIfSaIfEE9size_typeE)(__cuda_local_var_61167_6_non_const_matArow * __cuda_local_var_61168_15_non_const_matBcol)), ((((*(_ZNSt6vectorIfSaIfEE10value_typeE *)&__T22)) = (0.0F)) , (&__T22)), ((_ZNSaIfEC1Ev((&__T23))) , (((const _ZNSt6vectorIfSaIfEE14allocator_typeE *)&__T23)))); _ZNSaIfED1Ev((&__T23));
cudaMalloc(((void **)(&__cuda_local_var_61165_9_non_const_dA)), __cuda_local_var_61166_9_non_const_A_sz);
cudaMalloc(((void **)(&__cuda_local_var_61165_14_non_const_dB)), __cuda_local_var_61166_15_non_const_B_sz);
cudaMalloc(((void **)(&__cuda_local_var_61165_19_non_const_dC)), __cuda_local_var_61166_21_non_const_C_sz);
cudaMemcpy(((void *)__cuda_local_var_61165_9_non_const_dA), ((const void *)(_ZNSt6vectorIfSaIfEE5frontEv((&__cuda_local_var_61169_21_non_const_matA)))), __cuda_local_var_61166_9_non_const_A_sz, cudaMemcpyHostToDevice);
cudaMemcpy(((void *)__cuda_local_var_61165_14_non_const_dB), ((const void *)(_ZNSt6vectorIfSaIfEE5frontEv((&__cuda_local_var_61169_27_non_const_matBT)))), __cuda_local_var_61166_15_non_const_B_sz, cudaMemcpyHostToDevice);
_Z12regtileSgemmcciiifPKfiS0_ifPfi(((char)78), ((char)84), __cuda_local_var_61167_6_non_const_matArow, __cuda_local_var_61168_15_non_const_matBcol, __cuda_local_var_61167_15_non_const_matAcol, (1.0F), ((const float *)__cuda_local_var_61165_9_non_const_dA), __cuda_local_var_61167_6_non_const_matArow, ((const float *)__cuda_local_var_61165_14_non_const_dB), __cuda_local_var_61168_15_non_const_matBcol, (0.0F), __cuda_local_var_61165_19_non_const_dC, __cuda_local_var_61167_6_non_const_matArow);
cudaMemcpy(((void *)(_ZNSt6vectorIfSaIfEE5frontEv((&__cuda_local_var_61189_21_non_const_matC)))), ((const void *)__cuda_local_var_61165_19_non_const_dC), __cuda_local_var_61166_21_non_const_C_sz, cudaMemcpyDeviceToHost); {
 int i;
# 46 "main.cu"
i = 100; for (; (i < 103); i++) { {
 int j;
# 47 "main.cu"
j = 100; for (; (j < 103); j++) {
printf(((const char *)"%d "), ((double)(*(_ZNSt6vectorIfSaIfEE2atEm((&__cuda_local_var_61189_21_non_const_matC), ((_ZNSt6vectorIfSaIfEE9size_typeE)((i * __cuda_local_var_61170_6_non_const_n) + j))))))); } }
printf(((const char *)"\n"));
} }
cudaFree(((void *)__cuda_local_var_61165_9_non_const_dA));
cudaFree(((void *)__cuda_local_var_61165_14_non_const_dB));
cudaFree(((void *)__cuda_local_var_61165_19_non_const_dC)); {
_ZNSt6vectorIfSaIfEED1Ev((&__cuda_local_var_61189_21_non_const_matC)); _ZNSt6vectorIfSaIfEED1Ev((&__cuda_local_var_61169_27_non_const_matBT)); _ZNSt6vectorIfSaIfEED1Ev((&__cuda_local_var_61169_21_non_const_matA)); return 0; }
}
__asm__(".align 2");
# 865 "/usr/include/c++/4.8.2/bits/locale_facets.h" 3
